...
var initWebRoutes = function initWebRoutes(app) {
  ...
  router.post("/register", hashPassword, _userController["default"].handleRegister);
  router["delete"]("/user/:id", _userController["default"].handleDelete);
  router.post("/login", _userController["default"].handleLogin);
  router.get("/users", _userController["default"].handleGetUsers);
  router.get("/private", function (req, res, next) {
    try {
      var token = req.headers.authentication;
      var isTokenValid = _jsonwebtoken["default"].verify(token, "mk");
      if (isTokenValid) {
